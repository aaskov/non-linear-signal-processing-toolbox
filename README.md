...
### Examples
This is a timeseries prediction example using a Gaussian Process. Both the best log-likelihood and least-square fit is shown. A 95% confidence interval along the predictions is shown in the right figure.
<p align="center">
<img src="https://github.com/aaskov/nsp/blob/master/images/gp_example.png?raw=true" width="80%"/>
</p>

This is a two-class classification example using a Support Vector Machine. The algorihtm learns a set of support vectors that can be used for new (unseen) observations. The test result is shown in the right figure.
<p align="center">
